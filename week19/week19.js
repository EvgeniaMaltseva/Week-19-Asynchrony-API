...
function makeTwo() {
	...
	.then(htmlCode => p.innerHTML = htmlCode.htmlCode)
	result2.append(p)
}
...
function makeFour() {
	...
	fetch("https://www.boredapi.com/api/activity")
	.then(response => response.json())
	.then(activity => console.log("Activity: ", activity.activity));
}
...
function makeFive() {
	...
	fetch("https://www.boredapi.com/api/activity")
	.then(response => response.json())
	.then(participants => console.log("participants: ", participants.participants));
}
...
function makeSix() {
	...
	fetch("https://www.boredapi.com/api/activity")
	.then(response => response.json())
	.then(json => console.log("Activity: ", json.activity, "Type: ", json.type, "Price: ", json.price, "Accessibility: ", json.accessibility));
}
...
function makeFourteen() {
	fetch('https://official-joke-api.appspot.com/random_joke')
		...
		const result = (`Setup : ${data.setup}, Punchline : ${data.punchline}`)
...
function makeTwentyOne() {
	...
	fetch('https://jsonplaceholder.typicode.com/comments/1 ', {
		...
		body: JSON.stringify( commentsData1)
	})
	.then((response) => response.json())
	.then((data) => console.log(data))
	.catch((error) => console.error('Ошибка:', error));
